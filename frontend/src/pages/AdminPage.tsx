...
import { useGetAllBooks, useGetCallerUserRole, useUpdateBook, useDeleteBook } from '../hooks/useQueries';
                  ...
                  <div className="flex gap-3 md:gap-4 flex-1 w-full">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Owner: {book.uploaderId.toString().slice(0, 10)}... • Edits: {Number(book.editCount)}/3
                      </p>
                    </div>
                  </div>
